...
| Trend-strength sizing overlay on Tier 2A/Tier 3 | Best case `Tier 3` overlay: `R$18,363.17`, `PF 1.4868`, `DD 3.92%`, composite `3.0772` | Smarter sizing still raises gross net, but it increases drawdown enough that the research-only overlay does not beat the best exact deployable line on composite. |
