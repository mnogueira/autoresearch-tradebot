...
| ATR-regime sizing overlay on strengthened Tier 2A | `0.75x` size on top-ATR days, full size otherwise: `R$14,808.75`, `PF 1.5239`, `DD 2.75%`, composite `3.5722` | This is now the strongest raw research-only result of the sprint. It is a meaningful clue that the remaining upside is in sizing and execution quality, not another entry filter, but it still depends on variable sizing instead of a static MT5 preset. |
