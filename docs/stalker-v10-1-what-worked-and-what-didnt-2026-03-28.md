...
| Direction-specific ATR sizing on the advanced branch | `0.75x` on top-ATR days for short trades only: `R$15,737.50`, `PF 1.5294`, `DD 2.69%`, composite `3.7197`; all-sides trim was second at `3.6833`, and long-only trim fell to `3.3642` | This is now the strongest raw research-only result of the sprint. It shows the high-volatility pain is concentrated more on the short sleeve than the long sleeve, but it still depends on variable sizing rather than a static deployable preset. |
