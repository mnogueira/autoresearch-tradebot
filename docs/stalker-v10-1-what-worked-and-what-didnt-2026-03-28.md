...
| ROC agreement window sweep on Tier 2 | `ROC(5)` beat `ROC(20)` (`3.1117`) and `ROC(10)` (`3.0872`) on the exact composite | This confirmed the first tested ROC window was actually the best one, not just the first one tried. |
