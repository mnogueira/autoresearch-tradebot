...
| Tier 2A corrected `TP 0.48` + `60m` cooldown + Friday off + skip last `1` contract day, no ROC, no max-hold, `SL 1.0` | `R$3,024` | `1.0966` | `7.06%` | `R$887` | `1.1091` | `7.91%` | `R$241` | `1.1911` | strongest balanced corrected-cost branch, research only |
| Tier 2A corrected `TP 0.48` + `60m` cooldown + Friday off + skip last `1` contract day, no ROC, no max-hold | `R$2,104` | `1.0687` | `10.58%` | `R$1,007` | `1.1305` | `7.23%` | `R$331` | `1.2873` | best corrected-cost simplified holdout branch, research only |
