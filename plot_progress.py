...
Reads experiment results from results.tsv and produces a PNG chart showing
the progression of experiments with kept improvements highlighted.

Usage:
    python plot_progress.py [--input results.tsv] [--output progress.png]

Module usage:
    from plot_progress import generate_progress_chart
    path = generate_progress_chart(output_path="progress.png")
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", default="results.tsv",
        help="Path to the TSV results file (default: results.tsv)",
    )
    parser.add_argument(
        "--output", default="progress.png",
        help="Output PNG path (default: progress.png)",
    )
