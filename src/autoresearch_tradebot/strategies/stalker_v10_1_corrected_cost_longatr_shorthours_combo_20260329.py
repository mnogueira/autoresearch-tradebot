...
OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_longatr_shorthours_combo_20260329")
...
def main() -> None:
    ...
    summary = {
        ...
        "notes": [
            "Corrected-cost combined side-specific routing check.",
            "Goal: stack the two best static side-specific ideas without introducing variable sizing.",
        ],
    }
