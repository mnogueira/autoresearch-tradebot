...
OUTPUT_DIR = artifact_output_dir("wdo_mt5_new_signal_peak_hour_refine_20260330")
...
def main() -> None:
    ...
    specs = [
        PivotSpec(
            name="donchian20_high_atr_10_only_tp10",
            description="High-ATR Donchian 10h only with 1.0 ATR target.",
            signal_fn=lambda f: _signal_donchian_high_atr(f, {10}),
        ...
        PivotSpec(
            name="donchian20_high_atr_12_only_tp10",
            description="High-ATR Donchian 12h only with 1.0 ATR target.",
            signal_fn=lambda f: _signal_donchian_high_atr(f, {12}),
            sltp_fn=_fixed_sltp(1.0, 1.0),
            atr_col="atr14_m5",
            entry_start_hour=12,
            last_entry_hour=12,
        ...
        PivotSpec(
            name="donchian20_high_atr_10_only_tp12",
            description="High-ATR Donchian 10h only with 1.2 ATR target.",
            signal_fn=lambda f: _signal_donchian_high_atr(f, {10}),
        ...
        PivotSpec(
            name="donchian20_high_atr_12_only_tp12",
            description="High-ATR Donchian 12h only with 1.2 ATR target.",
            signal_fn=lambda f: _signal_donchian_high_atr(f, {12}),
            sltp_fn=_fixed_sltp(1.0, 1.2),
            atr_col="atr14_m5",
            entry_start_hour=12,
