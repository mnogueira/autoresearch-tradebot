...
OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_balanced_skip_thu_fri_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_no_roc_no_maxhold_sl1p0_tp0p48_cd60_skipthufri_skiplast1",
        rule=(
            "Corrected-cost balanced simplified branch with SL 1.00, TP 0.48, no ROC, no max-hold, "
            "Thursday and Friday off, skip last contract day."
        ),
        trades=trades,
        trade_dates=trade_dates,
    ...
    summary = {
        ...
        "notes": [
            "Static late-week pruning test around the corrected-cost balanced branch.",
            "Goal: check whether cutting the weaker Thursday/Friday sleeve improves robustness enough to justify the trade loss.",
        ],
    }
