...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_core_horizon_ultralocal_validation_20260329")
...
def main() -> None:
    ...
    params = replace(
        ...
        ATR_Length=10,
        NumDaysToConsiderPreviousContractMARange=1,
    )
    ...
    summary = {
        "variant_name": "tier2a_atr10_contractlookback1",
        "full_sample": {
