...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_tier2a_cooldown_validation_20260329")
...
def main() -> None:
    ...
    recent_60_trades = filter_trades_to_dates(full_trades, recent_60)
    recent_10_trades = filter_trades_to_dates(full_trades, recent_10)

    summary = {
        "variant_name": "tier2a_atr10_contractlookback2_cooldown28",
        "full_sample": {
