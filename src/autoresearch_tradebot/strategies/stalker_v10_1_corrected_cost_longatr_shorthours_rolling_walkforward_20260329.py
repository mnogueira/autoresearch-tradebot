...
OUTPUT_DIR = artifact_output_dir(
    "stalker_v10_1_corrected_cost_longatr_shorthours_rolling_walkforward_20260329"
)
...
def main() -> None:
    ...
    entry_filter = _combine_filters(
        ...
        _date_filter(_date_set(trade_dates)),
    ...
    summary = {
        "variant": _variant_payload(
            ...
            rule="Corrected-cost branch that prunes longs on top ATR days and restricts shorts to 10/11/12.",
            trades=full_trades,
            trade_dates=trade_dates,
        ...
        "notes": [
            "Rolling walk-forward for the side-specific corrected-cost static branch.",
            "Compares the stacked long ATR prune plus short-hours branch against the simpler long-ATR-pruned branch.",
        ],
    }
