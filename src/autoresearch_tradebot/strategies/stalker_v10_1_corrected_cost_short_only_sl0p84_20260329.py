...
OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_short_only_sl0p84_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_no_roc_no_maxhold_sl0p84_tp0p48_cd60_skipfriday_skiplast1_short_only",
        rule="Balanced corrected-cost branch using short-only entries with SL 0.84.",
        trades=trades,
        trade_dates=trade_dates,
