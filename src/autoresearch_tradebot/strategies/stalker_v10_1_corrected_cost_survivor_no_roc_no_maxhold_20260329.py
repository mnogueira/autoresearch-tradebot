...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_survivor_no_roc_no_maxhold_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_no_roc_sl0p84_tp0p48_cd60_skipfriday_skiplast1",
        rule="Corrected-cost strengthened Tier 2A survivor branch without ROC agreement and without max-hold.",
        trades=trades,
        trade_dates=trade_dates,
    ...
    summary = {
        ...
        "notes": [
            "Single-variant simplification probe around the corrected-cost holdout leader.",
            "Goal: isolate whether max-hold is still useful once ROC agreement has been removed.",
        ],
    }
