...
OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_short_only_cd45_20260329")
...
def main() -> None:
    ...
    management = ManagementConfig(min_minutes_between_entries=45)
    ...
    payload = _variant_payload(
        name="tier2a_corrected_no_roc_no_maxhold_sl1p0_tp0p48_cd45_skipfriday_skiplast1_short_only",
        rule="Balanced corrected-cost branch using short-only entries with 45m cooldown.",
        trades=trades,
        trade_dates=trade_dates,
        params={"params": asdict(params), "management": asdict(management), "direction": "short_only"},
    )
    summary = {
        "variant": payload,
        "walkforward_70_30": {
