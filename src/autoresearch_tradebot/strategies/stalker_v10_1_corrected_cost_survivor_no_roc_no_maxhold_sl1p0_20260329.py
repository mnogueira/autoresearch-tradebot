...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_survivor_no_roc_no_maxhold_sl1p0_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_no_roc_sl1p0_tp0p48_cd60_skipfriday_skiplast1",
        rule="Corrected-cost strengthened Tier 2A survivor branch without ROC agreement, without max-hold, and with SL 1.00.",
        trades=trades,
        trade_dates=trade_dates,
    ...
    summary = {
        ...
        "notes": [
            "Single-variant follow-up around the corrected-cost simplified holdout leader.",
            "Goal: isolate whether widening the stop to 1.00 improves the simpler no-ROC, no-max-hold branch.",
        ],
    }
