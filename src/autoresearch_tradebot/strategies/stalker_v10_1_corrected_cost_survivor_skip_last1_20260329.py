...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_survivor_skip_last1_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_tp048_cd60_skipfriday_skiplast1",
        rule="Corrected-cost strengthened Tier 2A with TP 0.48, 60-minute cooldown, Friday skipped, and last contract day skipped.",
        trades=trades,
        trade_dates=trade_dates,
    ...
    summary = {
        ...
        "notes": [
            ...
            "Goal: isolate whether skipping the last contract day helps the Friday-off TP 0.48 / 60-minute survivor branch.",
        ],
    }
