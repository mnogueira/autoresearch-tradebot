...
OUTPUT_DIR = artifact_output_dir("wdo_mt5_new_signal_peak_12h_refine_20260330")
...
def main() -> None:
    ...
    specs = [
        PivotSpec(
            name="donchian20_high_atr_12_only_tp09",
            description="12h-only high-ATR Donchian with 0.9 ATR target.",
            signal_fn=lambda f: _signal_donchian_high_atr_12h(f, False),
            sltp_fn=_fixed_sltp(1.0, 0.9),
            atr_col="atr14_m5",
            entry_start_hour=12,
            last_entry_hour=12,
        ...
        PivotSpec(
            ...
            description="12h-only high-ATR Donchian with 1.5x volume gate.",
            signal_fn=lambda f: _signal_donchian_high_atr_12h(f, False),
        ...
        PivotSpec(
            name="donchian20_high_atr_12_only_tp09_volume",
            description="12h-only high-ATR Donchian with 0.9 ATR target and volume gate.",
            signal_fn=lambda f: _signal_donchian_high_atr_12h(f, False),
            sltp_fn=_fixed_sltp(1.0, 0.9),
            atr_col="atr14_m5",
            entry_start_hour=12,
        ...
        PivotSpec(
            name="donchian20_high_atr_12_only_tp10_m5",
            description="12h-only high-ATR Donchian with M5 EMA agreement.",
