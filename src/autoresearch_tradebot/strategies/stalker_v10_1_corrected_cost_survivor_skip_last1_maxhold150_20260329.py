...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_corrected_cost_survivor_skip_last1_maxhold150_20260329")
...
def main() -> None:
    ...
    payload = _variant_payload(
        name="tier2a_corrected_tp048_cd60_skipfriday_skiplast1_maxhold150",
        rule="Corrected-cost strengthened Tier 2A with TP 0.48, 60-minute cooldown, Friday skipped, last contract day skipped, and 150-minute max-hold.",
        trades=trades,
        trade_dates=trade_dates,
    ...
    summary = {
        ...
        "notes": [
            "Single-variant follow-up around the improved corrected-cost static survivor.",
            "Goal: isolate whether adding a 150-minute max-hold further improves the Friday-off + skip-last-contract-day TP 0.48 / 60-minute survivor branch.",
        ],
    }
