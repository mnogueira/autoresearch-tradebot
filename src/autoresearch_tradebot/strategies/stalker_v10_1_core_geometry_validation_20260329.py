...
DEFAULT_OUTPUT_DIR = artifact_output_dir("stalker_v10_1_core_geometry_validation_20260329")
...
def main() -> None:
    ...
    params = replace(session_winner_params(), FilterAsPercOfContractMARange=0.25)
    ...
    summary = {
        "variant_name": "tier2a_contractrange_0p25",
        "full_sample": {
