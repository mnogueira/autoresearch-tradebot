...
def build_handoff_report() -> dict:
    ...
    checks = {
        ...
        "tier2a_preset": root / "mt5/profiles/tester/WDO Stalker Strategy v10.1 Surgical SLTP sl0p84 tp0p3 Skip Hour13 All Sides Cooldown 28m ROC5 Agreement ATR10 Lookback2 GPT 5.4.set",
        ...
        "tier3_preset": root / "mt5/profiles/tester/WDO Stalker Strategy v10.1 Surgical SLTP sl0p84 tp0p3 Skip Hour13 All Sides Cooldown 25m MaxHold150m ROC5 Agreement ATR10 Lookback2 GPT 5.4.set",
        ...
        "tier2a_artifact": root / "artifacts/outputs/stalker_v10_1_tier2a_cooldown_validation_20260329/summary.json",
        ...
        "tier3_artifact": root / "artifacts/outputs/stalker_v10_1_tier3_local_geometry_validation_20260329/summary.json",
    }
